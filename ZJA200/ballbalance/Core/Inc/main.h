...
/* Private defines -----------------------------------------------------------*/
#define stx_Pin GPIO_PIN_2
#define stx_GPIO_Port GPIOA
#define srx_Pin GPIO_PIN_3
...
#define vtx_Pin GPIO_PIN_9
#define vtx_GPIO_Port GPIOA
#define vrx_Pin GPIO_PIN_10
#define vrx_GPIO_Port GPIOA

/* USER CODE BEGIN Private defines */
 extern float pide;   /* 调试变量: 误差 e, 定义在 main.c */
