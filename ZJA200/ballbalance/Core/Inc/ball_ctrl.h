...
#define BALL_CTRL_KP_DEFAULT         20.0f//20.0f//1.2f   /**< 比例增益 (deg/cm, 实测调参) */
#define BALL_CTRL_KI_DEFAULT         18.0f//15.0f//1.0f   /**< 积分增益 (消除稳态误差) */
#define BALL_CTRL_KD_DEFAULT         10.0f//5.0f//0.01f   /**< 微分增益 (阻尼, 抑制振荡) */
#define BALL_CTRL_II_MAX_DEG         15.0f  /**< 积分项输出上限 (防积分饱和) */
#define BALL_CTRL_DEADBAND_CM        0.3f   /**< 位置死区 (cm) */
#define BALL_CTRL_MIN_ANGLE_DEG      1.0f   /**< 最小动作角, 防止零碎抖动 */
#define BALL_CTRL_MAX_ANGLE_DEG      45.0f  /**< 倾角限幅 (机械极限 45°) */
 ...
 */
#define BALL_CTRL_CREEP_ANGLE_DEG    6.0f   /**< 最小蠕动角 */
...
#define BALL_MOTOR_RPM               200u             /**< 电机转速 */
#define BALL_MOTOR_ACC               10u              /**< 电机加速度 */
